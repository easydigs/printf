...
int write_character(char character, char output_buffer[], int flags, int width, int precision, int size);
int write_number(int is_negative, int index, char output_buffer[], int flags, int width, int precision, int size);
...
int print_binary_format(va_list args, char output_buffer[], int flags, int width, int precision, int size);:wq
